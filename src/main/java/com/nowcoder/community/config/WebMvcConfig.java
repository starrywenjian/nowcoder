...
import com.nowcoder.community.controller.interceptor.UnreadInterceptor;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    @Autowired
    private UnreadInterceptor unreadInterceptor;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(unreadInterceptor).excludePathPatterns("/**/*.css", "/**/*.js", "/**/*.png", "/**/*.jpg", "/**/*.jpeg");
    }

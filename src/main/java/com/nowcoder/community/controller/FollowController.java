...
public class FollowController implements CommunityConstant {
    ...
    public String follow(int entityType, int entityId) {
        ...
        event.setTopic(TOPIC_FOLLOW)
                ...
                .setEntityUserId(entityId);// 当前只可能关注人，所以这里直接写entityId，后期扩展的话，这里就要改
    ...
    public String followees(@PathVariable("userId") int userId, Model model, Page page) {
    ...
    public String followers(@PathVariable("userId") int userId, Model model, Page page) {
        User user = userService.findUserById(userId);
        if (user == null) {
            throw new RuntimeException("该用户不存在");
        }
